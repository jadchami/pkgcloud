 ...
 *
 * @description updates the os_type metadata of image to windows
 *
 * @param {String|object}     image     the image or imageId to get
 * @param callback
 * @returns {*}
 */
exports.updateImageMeta = function updateImageMeta(image, callback) {
  var imageId = image instanceof compute.Image ? image.id : image;
  ...
  return this._request({
      path: urlJoin(_urlPrefix, imageId, 'metadata', 'os_type' ),
      method: 'PUT',
	  body: specs
    },
    function (err) {
